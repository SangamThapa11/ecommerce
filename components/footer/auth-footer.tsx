            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <p className="text-white transition hover:opacity-75">
                  ...
                  LATEST LAPTOPS <br />
                  Apple Laptops , Samsung Laptops , Asus Laptops , Acer Laptops , HP Laptops , Dell Laptops <br />
                  LED TVS PRICES <br />
                  Samsung LED TVs , Sony LED TVs , Videocon LED TVs <br />
                  SUMMER APPLIANCES <br />
                  Air Conditioners , Refrigerators & Fridges , Samsung Refrigerators , Deep Freezers , Generators & Portable Power , Water Dispensers<br />
                  CAMERAS<br />
                  Camera Tripods , Drones , IP & CCTV Cameras<br />
                </p>
              </li>
            </ul>
          </div>
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <p className="text-white transition hover:opacity-75">
                  ...
                  Goldstar Shoes , Dell , Samsung , Canon , Oppo , Sony , Nokia , Apple <br />
                  TRENDING PRODUCTS <br />
                  Vivo Y20 , Oppo A12 , Samsung Galaxy M31 , iPhone 12 , Redmi 9A , Poco F3 , Samsung M12 , Oppo F19 Pro , Samsung A32 , Infinix Hot 10 , Samsung A12 , OnePlus Nord 2 , Samsung M62 , Samsung M32 , TVS Ntorq , Poco X3 Pro , Poco C3 , Acer Nitro 5 , Samsung F22 , MI 11 Lite , Gold , Macbook Air , iPad Pro , Lenovo Legion 5 , Acer Aspire 5 , Ideapad 3 , HP Pavilion 15 , Khukri Rum , Micromax In Note 1 , Realme 9i , Realme 9 Pro+ , Gas Geyser , Black Horse , Cactus Toy , Antigen Testkit , PS5 , Electric Scooter , Z Flip 3 , Tab S6 , Tab A8 , Stealth 13 <br />
                  SHOP WORLDWIDE WITH LAZADA <br />
                  Singapore , Malaysia , Philippines , Indonesia , Vietnam , Thailand
                  SHOP WORLDWIDE WITH MIRAVIA <br />
                  Spain , Portugal
                </p>
              </li>
            </ul>
