      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <div className="flex gap-4">
            <Link href="/login" className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
              Add to Cart
            </Link>
            <Link href="/login"  className="border border-teal-600 text-teal-600 hover:bg-teal-50 px-6 py-3 rounded-lg font-medium transition-colors">
              Buy Now
            </Link>
          </div>
